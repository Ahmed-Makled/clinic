                                    ...
                                    <div class="col">
                                        <div class="d-flex flex-column doctor-info">
                                            <div class="doctor-header mb-3">
                                                <h4 class="mb-2 fw-bold text-primary">{{ $doctor->name }}</h4>
                                                <div class="rating-text">
                                                    @for ($i = 1; $i <= 5; $i++)
                                                        ...
                                                        @endif
                                                    @endfor
                                                    <span class="rating-score ms-2">{{ number_format($doctor->average_rating, 1) }}</span>
                                            ...
                                            <div class="doctor-details">
                                                <p class="text-muted mb-3 doctor-speciality">
                                                    ...
                                                    أستاذ جامعي تخصص {{ $doctor->categories->pluck('name')->implode(', ') }}
                                                </p>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    class="btn btn-primary btn-lg rounded-3 px-4 book-btn">
...
@media (max-width: 768px) {
    ...
    .doctors-container.grid-view .info-items-container,
    .doctors-container.list-view .info-items-container {
        justify-content: center;
    }
}
...
.doctors-container.grid-view .book-btn {
    width: 100%;
}
...
.doctors-container.list-view .book-btn {
    width: auto;
}
