        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="card shadow-sm rounded-4">
                ...
                <div class="card-body px-4 py-3">
                    <form method="POST" action="{{ route('admin.patients.store') }}" class="needs-validation" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="mt-4">
                            ...
                            <a href="{{ route('admin.patients.index') }}" class="btn btn-label-secondary">إلغاء</a>
                        </div>
                    </form>
                </div>
            </div>
