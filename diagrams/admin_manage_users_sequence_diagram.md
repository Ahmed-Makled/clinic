...
sequenceDiagram
    ...
    Note over Admin,UsersController: Shows: users list, search filters,<br/>role filters, status filters, pagination
    ...
    alt View User Details
        ...
        Note over Admin,UsersController: Shows: complete user profile,<br/>roles, status, related records
    end
    ...
    alt Create New User Flow
        ...
        UsersController-->>+ValidationSystem: Validate user data
        ValidationSystem-->>ValidationSystem: Check email uniqueness
        ValidationSystem-->>ValidationSystem: Validate password strength
        ValidationSystem-->>ValidationSystem: Validate phone format
        
        alt Validation Failed
            ValidationSystem-->>UsersController: Return validation errors
            UsersController-->>Admin: Display validation errors
        else Validation Successful
            ValidationSystem-->>UsersController: Data validated
            ...
            alt Doctor Role Selected
                ...
                Note over Admin,UsersController: Admin user created<br/>no additional profile needed
            end
        end
        ValidationSystem-->>-UsersController: Complete user creation validation
    end
    ...
    alt Edit User Flow
        ...
        UsersController-->>+ValidationSystem: Validate updated data
        ValidationSystem-->>ValidationSystem: Check email uniqueness (excluding current)
        ValidationSystem-->>ValidationSystem: Validate optional password
        ...
        ValidationSystem-->>-UsersController: Complete user edit validation
    end
